/*
	...
	MODIFIED FOR THE TOUCH DIRECTORY TO USE ONLY MOUSEUP.
*/
;(function($) {
	...
	$.fn.fancybox = function(options) {
		...
		$(this).unbind('mouseup.fb').bind('mouseup.fb', function(e) {
			e.preventDefault();
	...
	*/
	...
	function _finish() {
		...
		currentOpts.hideOnContentClick ? inner.one('mouseup',		$.fancybox.close )	: inner.unbind();
 		currentOpts.hideOnOverlayClick ? overlay.one('mouseup',	$.fancybox.close )	: overlay.unbind();
	...
	function fancybox_init() {
		...
		close.mouseup($.fancybox.close);
		loading.mouseup($.fancybox.cancel);

		nav_left.bind("mouseup", function(e) {
			e.preventDefault();
			$.fancybox.prev();
		});

		nav_right.bind("mouseup", function(e) {
			e.preventDefault();
			$.fancybox.next();
		});
